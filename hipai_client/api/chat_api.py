...
class ChatApi(object):
    ...
    def completions_api_chat_completions_post(self, body, **kwargs):  # noqa: E501
        """Completions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.completions_api_chat_completions_post(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.completions_api_chat_completions_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.completions_api_chat_completions_post_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def completions_api_chat_completions_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """Completions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.completions_api_chat_completions_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method completions_api_chat_completions_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `completions_api_chat_completions_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ChatCompletion',  # noqa: E501
