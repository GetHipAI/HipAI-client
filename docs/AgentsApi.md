...
> Message delete_agent_api_agents_id_delete(id, project_id=project_id)
...
> AgentConfigObject load_agent_api_agents_id_get(id, project_id=project_id, group_id=group_id)
