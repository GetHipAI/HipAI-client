...
[**list_model_configs_api_model_configs_list_post**](ModelConfigsApi.md#list_model_configs_api_model_configs_list_post) | **POST** /api/model-configs/list | List Model Configs
...
> Message delete_model_config_api_model_configs_id_delete(id, body=body)
...
try:
    # Delete Model Config
    api_response = api_instance.delete_model_config_api_model_configs_id_delete(id, body=body)
    pprint(api_response)
...
# **list_model_configs_api_model_configs_list_post**
> ApiModelConfigModelsListResponse list_model_configs_api_model_configs_list_post(body)
...
try:
    # List Model Configs
    api_response = api_instance.list_model_configs_api_model_configs_list_post(body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ModelConfigsApi->list_model_configs_api_model_configs_list_post: %s\n" % e)
```
